...
export function Signup() {
    ...
    const signup = async (credentials) => {
        try {
            ...
            const { data: { result }} = await axios.post("https://e-commerce-backend.ashishgupta08.repl.co/user/signup", { username:credentials.username, password:credentials.password, name:credentials.name, email:credentials.email } );
    ...
    return (
        <div className="login-page">
            ...
            <div className="box-content">
                <h1 className="logo">100 STEPS</h1>
                <div className="form">
